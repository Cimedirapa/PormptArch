...
import { Trash2, Edit2, Settings, Moon, Sun, Check, X, Box, Lightbulb, GripVertical, ChevronLeft, ChevronRight } from 'lucide-react';
                    ...
                    {editingId === project.id ? (
                        ...
                        <div className="flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                            ...
                            <button 
                                ...
                                className="p-1 rounded text-zinc-400 group/trash hover:bg-red-100 dark:hover:bg-red-900/30 transition-all duration-200 hover:scale-110"
                                title="Move to trash"
                            >
                                <Trash2 size={12} className="group-hover/trash:text-red-600 transition-colors" />
                            </button>
                        </div>
                        </div>
                    )}
...
export const Sidebar: React.FC = () => {
  ...
  return (
    <div className={`relative h-full flex-shrink-0 z-20 ${isOpen ? 'w-64' : 'w-3'} transition-all duration-300 ease-in-out`}>
        <div 
            className={`h-full bg-white dark:bg-zinc-950 border-r border-zinc-200 dark:border-zinc-800 overflow-hidden flex flex-col`}
        >
            <div className={`w-64 h-full flex flex-col ${isOpen ? 'opacity-100 visible' : 'opacity-0 invisible'} transition-all duration-300`}>
                {/* Logo */}
                <div 
                    ...
                    <div className="flex items-center justify-between px-2 pt-2">
                        ...
                        <div className="relative">
                            ...
                            {settingsOpen && (
                                ...
                                <div className="absolute bottom-full right-0 mb-2 w-48 bg-white dark:bg-zinc-900 rounded-lg shadow-xl border border-zinc-200 dark:border-zinc-700 p-3 z-50">
                                    <div className="mb-3">
        ...
        <button
            ...
            className="absolute -right-0 top-1/2 -translate-y-1/2 z-50 p-0.5 bg-white dark:bg-zinc-800 border-y border-r border-zinc-200 dark:border-zinc-700 rounded-r-md shadow-sm text-zinc-400 hover:text-violet-600 dark:hover:text-violet-400 transition-colors flex items-center justify-center w-3 h-8"
