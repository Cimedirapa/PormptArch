       ...
       <div className="flex items-center gap-4">
        ...
        <div className="relative w-[140px] flex-shrink-0">
             <input
                ...
                className="w-full bg-zinc-50 dark:bg-zinc-900 rounded-full px-4 py-2 text-sm text-zinc-900 dark:text-zinc-100 focus:outline-none focus:ring-1 focus:ring-violet-500 transition-all border border-transparent focus:border-violet-500 pr-8"
            />
